...
const faqData = [
  ...
  {
    question: "Is the interview process fully automated?",
    answer:
      "Yes, the system automates the interview process using AI-driven questions, real-time analysis, and feedback, reducing manual effort while ensuring consistent and fair evaluations."
  },
  {
    question: "Is candidate data secure in the system?",
    answer:
      "Yes, the system ensures data privacy and security by implementing secure storage and processing practices to protect candidate information."
  },
  {
    question: "Can recruiters customize interview questions?",
    answer:
      "Yes, recruiters can customize interview questions based on job requirements to ensure relevant and role-specific evaluations."
  }
];
  const plans = [
    {
  ...
  <div className="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
    ...
    <a href="/" className="logo d-flex align-items-center">
      ...
      <h1 className="sitename d-none d-sm-block">Smartly Hire</h1>
    </a>

  <nav className="navmenu d-flex align-items-center gap-2">
  <a href="#hero" style={{ fontWeight: "700" }}>Home</a>
  <a href="#values" style={{ fontWeight: "700" }}>Values</a>
  <a href="#services" style={{ fontWeight: "700" }}>Services</a>
  <a href="#faq" style={{ fontWeight: "700" }}>FAQ</a>
  <a href="#contact" style={{ fontWeight: "700" }}>Contact</a>
</nav>
    {/* Buttons */}
    <div className="d-flex align-items-center gap-2">
      <button className="btn-getstarted" onClick={handleRecruiterlogin}>
        Join as Recruiter
      </button>

      <button className="btn-getstarted" onClick={handleCandidatePage}>
        Join as Candidate
      </button>
    </div>
      ...
      <div className="hero-row">
        ...
        <div className="hero-text-column">
          ...
          >
            ...
            <a
              href="https://www.youtube.com/channel/UCxE3vM6cYJZkJldveOCwgnQ"
  ...
  <div className="section-title">
    ...
    <p>What Drives Smartly Hire Forward</p>
  </div>
  ...
  <div className="values-cards-container">
    <div className="values-card" data-aos="fade-up" data-aos-delay={100}>
      <div className="card">
        ...
        <p>Create impactful job posts</p>
        <p>Reach a wider audience</p>
        <p>Simplify recruitment process</p>
      </div>
    </div>
    ...
    <div className="values-card" data-aos="fade-up" data-aos-delay={200}>
      <div className="card">
        ...
        <p>AI-powered voice interaction</p>
        <p>Real-time response analysis</p>
        <p>Enhance interview experience</p>
      </div>
    </div>
    ...
    <div className="values-card" data-aos="fade-up" data-aos-delay={300}>
      <div className="card">
        ...
        <p>Quick and easy apply process</p>
        <p>User-friendly interface</p>
        <p>Reduced application time</p>
      </div>
    </div>
  </div>
</section>
...
<section id="faq" className="faq section">
  ...
  <div className="container" data-aos="fade-up" data-aos-delay={100}>
    ...
    <p> Stay connected with Smartly Hire for updates, support, and AI-powered hiring innovations.
</p>
  </div>
  <div className="container">
        ...
        <div className="info-row">
          <div className="info-card">
            ...
            <div className="info-content">
              <h3>Address</h3>
              <p>Superior University, Gold Campus</p>
              <p>Lahore, Pakistan</p>
            </div>
          </div>
          ...
          <div className="info-card">
            ...
            <div className="info-content">
              <h3>Email Us</h3>
              <p>hifzaofpk@gmail.com</p>
                <p>zubairiftikhar142@gmail.com</p>
                  <p>baqirsultan109109@gmail.com</p>
            </div>
          </div>
    ...
    <div className="row">
      <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
        <a href="index.html" className="logo d-flex align-items-center mb-3">
          <span className="sitename">Smartly Hire</span>
        </a>
        <div className="footer-contact text-center text-md-start">
          <p>Superior University, Gold Campus</p>
          <p>BS Software Engineering</p>
          <p className="mt-2">
            <strong>Phone:</strong> <span>+92 308 8000052</span>
          </p>
          <p>
            <strong>Email:</strong> <span>smartlyhire.ai@gmail.com</span>
          </p>
        </div>
      </div>
...
<a href="https://www.facebook.com/people/Smartly-Hire/61563223274134/?rdid=HBm5rSXNVyqKEAx4&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1cWDb2Ftg8" className="facebook">
  <i className="bi bi-facebook"></i>
</a>

<a href="https://www.instagram.com/SMARTLYHIRE" className="instagram">
  <i className="bi bi-instagram"></i>
</a>

<a href="https://www.linkedin.com/in/smartly-hire-7baba5405/" className="linkedin">
  <i className="bi bi-linkedin"></i>
</a>

<a href="https://www.youtube.com/channel/UCxE3vM6cYJZkJldveOCwgnQ" className="youtube">
  <i className="bi bi-youtube"></i>
</a>

<a href="https://www.tiktok.com/@smartly.hire" className="tiktok">
  ...
  <div className="container copyright text-center py-5 ">
    <p>
      © <span>Copyright</span> <strong className="px-1 sitename">Smartly Hire</strong> <span>All Rights Reserved</span>
    </p>
    <div className="credits">
  Designed and Developed by{" "}
  <a href="https://www.linkedin.com/in/hifza-khalid/">Hifza</a>,{" "}
  <a href="https://www.linkedin.com/in/baqir-sultan-025715300/">Baqir</a>{" "}
  And{" "}
  <a href="https://www.linkedin.com/in/hafiz-muhammad-zubair-hmz4998/">
    Zubair
  </a>
</div>
  </div>
